...
public class CashierPanelGUI extends JFrame {
    ...
    private JPanel createLeftBox() {
        ...
        JButton foodBtn = createImageButton("assets/Meals.png", 30, 70, 200, 200);
        JButton drinkBtn = createImageButton("assets/drinks.png", 30, 270, 200, 200);
        JButton dessertBtn = createImageButton("assets/dessrt.png", 30, 450, 200, 200);
        JButton equipmentBtn = createImageButton("assets/Equipment.png", 30, 630, 200, 200);
