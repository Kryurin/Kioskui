...
public class AdminPanelGUI extends JFrame {
    ...
    private void refreshLists() {
        ...
        for (Membership m : membershipManager.getMembership()) {
    ...
    private JPanel createProductPanel() {
        ...
        addButton.addActionListener(e -> {
            try {
                ...
                int id = otherMethods.generateUniqueID();
                ...
                switch (category) {
                    case "Food" -> {
                        ...
                        if (!invalid) {
                            Product product = new Food(name, id, quantity, price, (String) foodTypeBox.getSelectedItem());
                    ...
                    case "Drink" -> {
                        ...
                        if (!invalid) {
                            Product product = new Drink(name, id, quantity, price, type, size);
                            productManager.addProduct(product);
                        }
                    }
                    case "Dessert" -> {
                        ...
                        if (!invalid) {
                            Product product = new Dessert(name, id, quantity, price, type, serving);
                            productManager.addProduct(product);
                        }
                    }
                }
    ...
    private JPanel createEquipmentPanel() {
        ...
        addButton.addActionListener(e -> {
            ...
            Equipment equipment = new Equipment(name, id, description);
    ...
    private JPanel createDeletePanel() {
        ...
        deleteProductBtn.addActionListener(e -> {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                productManager.removeProduct(selected);
                refreshLists();
        ...
        deleteEquipmentBtn.addActionListener(e -> {
            ...
            int confirm = JOptionPane.showConfirmDialog(panel,
                    ...
                    "Confirm Deletion", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                equipmentManager.removeEquipment(selected);
                refreshLists();
        ...
        deleteMembershipBtn.addActionListener(e -> {
            ...
            int confirm = JOptionPane.showConfirmDialog(panel,
                    ...
                    "Confirm Deletion", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                membershipManager.removeMembership(selected);
                refreshLists();
