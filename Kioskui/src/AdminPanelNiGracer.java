...
public class AdminPanelNiGracer extends JFrame {
    ...
    private void refreshMainButtons() {
        if (deleteButton != null) {
            boolean show = productMenu.count() >= 3 && equipmentMenu.count() >= 3;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            AdminPanelNiGracer app = new AdminPanelNiGracer();
            app.setVisible(true);
        });
    }
}