...
public class KitchenPanelGUI extends JFrame {
    ...
    private static KitchenPanelGUI instance;
    ...
    private KitchenPanelGUI(OrderQueue orderQueue) {
        ...
        titleLabel.setBounds(120, 30, 700, 40);
        ...
        contentPanel.setBounds(120, 80, 700, 450);
        ...
        queueList.setFont(new Font("Consolas", Font.PLAIN, 16));
        ...
        detailsArea.setFont(new Font("Consolas", Font.PLAIN, 16));
        ...
        queueStatusLabel.setFont(new Font("Consolas", Font.BOLD, 16));
        ...
        // Back button
        JButton backButton = createStyledButton("Back", 370, 540);
    ...
    public static synchronized KitchenPanelGUI getInstance(OrderQueue orderQueue) {
        if (instance == null || !instance.isDisplayable()) {
            instance = new KitchenPanelGUI(orderQueue);
        }
        return instance;
    }
